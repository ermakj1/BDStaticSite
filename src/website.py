...
def generate_page(from_path, template_path, dest_path, dest_dir_path, site_root):
    ...
    template = re.sub(r'href="/', f'href="{site_root}', template)
    #replace src="/ with src="{from_path}/"
    template = re.sub(r'src="/', f'src="{site_root}', template)
